...
class ImprovedRandomNoteSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            ...
            text
                .setValue(((_b = this.plugin.settings.excludedTags) === null || _b === void 0 ? void 0 : _b.join(', ')) || '')
                .onChange((value) => __awaiter(this, void 0, void 0, function* () {
...
class ImprovedRandomNotePlugin extends obsidian.Plugin {
    constructor() {
        super(...arguments);
        this.settings = { openInNewLeaf: true, enableRibbonIcon: true, selectedTag: '', excludedFolders: '', includedFolders: '', excludedTags: [] };
        this.ribbonIconEl = undefined;
        this.onunload = () => {
        };
        this.handleOpenRandomNote = () => __awaiter(this, void 0, void 0, function* () {
            yield this.openRandomNote(this.app.vault.getMarkdownFiles());
        });
    ...
    excludeTags(files) {
        var _a;
        if (!((_a = this.settings.excludedTags) === null || _a === void 0 ? void 0 : _a.length)) {
            return files;
        }
        const tagFilesMap = getTagFilesMap(this.app);
        let filesToExclude = new Set();
